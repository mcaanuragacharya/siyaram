 ...
 */
namespace Purpletree\Rma\Block\Adminhtml\Status;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('delete', 'label', __('Delete Status'));
    }
    /**
    ...
    public function getHeaderText()
    {
        ...
        if ($status->getPtsStatusId()) {
            return __("Edit Status '%1'", $this->escapeHtml($status->getPtsName()));
        }
