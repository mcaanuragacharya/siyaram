 ...
 */
namespace Purpletree\Rma\Block\Adminhtml\Reason;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize Reason edit block
     *
     * @return void
     */
    protected function _construct()
    {
        $this->_objectId = 'pts_reason_id';
    ...
    /**
     * Retrieve text for header element depending on loaded Reason
     *
     * @return string
     */
    public function getHeaderText()
    {
        ...
        if ($reason->getPtsReasonId()) {
            return __("Edit Reason '%1'", $this->escapeHtml($reason->getPtsName()));
        }
