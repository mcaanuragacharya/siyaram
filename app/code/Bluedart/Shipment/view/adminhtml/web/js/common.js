...
myObj={
    ...
    defaultVal:function(){
        this.shipperCountry=$('bluedart_shipment_shipper_country').value;
        this.shipperCity=$('bluedart_shipment_shipper_city').value;
        this.shipperZip=$('bluedart_shipment_shipper_postal').value;
        this.shipperState=$('bluedart_shipment_shipper_state').value;

        this.recieverCountry=$('bluedart_shipment_receiver_country').value;
        this.recieverCity=$('bluedart_shipment_receiver_city').value;
        this.recieverZip=$('bluedart_shipment_receiver_postal').value;
        this.recieverState=$('bluedart_shipment_receiver_state').value;
    },
    cropValues:function(){
        this.defaultVal();	
    ...
    openPickup:function(){
        ...
        $('pickup_address').value=$('bluedart_shipment_shipper_street').value;
        $('pickup_company').value=$('bluedart_shipment_shipper_company').value;
        $('pickup_contact').value=$('bluedart_shipment_shipper_name').value;					
        $('pickup_email').value=$('bluedart_shipment_shipper_email').value;
