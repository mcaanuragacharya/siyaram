...
class Massshipment extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if (count($post_out["selectedOrders"])) {
            foreach ($post_out["selectedOrders"] as $key => $order_id) {
                $output = $this->ShipmentCreation($order_id);//print_r($output);
                if ($output[1] == "error") {
    ...
    protected function ShipmentCreation($order_id){
        ...
        foreach($itemsv as $itemvv){
            ...
            if($itemvv->getQtyOrdered()==$itemvv->getQtyShipped()){
                ...
                $bluedart_items['ItemDetails'][] = array(
                    ...
                    'SubProduct4' => '',
                    'countryOfOrigin' => '',
					'InvoiceDate' => '2017-10-31T00:00:00',
				    'InvoiceNumber' => '',
				    'PlaceofSupply' => '',
					'ReturnReason' => ''
                );
        ...
        $service_pickupdate = '2017-11-08T10:33:00';// $params['service_pickupdate'];
        ...
        $service_customerEDD = '2017-11-17T10:33:00';// $params['service_customerEDD'];
		    ...
		    'Services' => 
		      array (
		        ...
		        'Dimensions' =>
		          ...
		          'InvoiceNo' => "001",//$service_invoiceno,
		          ...
		          'ItemCount' => count($itemsv),//$service_itemcount,
